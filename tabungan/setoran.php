				...
				<form method="post" action="input_setoran.html" class="" >
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group">
									<input type="text" class="form-control" id="id_siswa" name="id_siswa" placeholder="Nomor No Rekening" required="" readonly>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Anggota" required="" readonly>
							</div>
						</div>
